...
# Cross attention
_C.MODEL.USE_CROSS_ATTENTION = False
_C.MODEL.CROSS_ATTENTION_DIM = 512
_C.MODEL.CROSS_ATTENTION_HEADS = 8
_C.MODEL.CROSS_ATTENTION_FFN_DIM = 2048
_C.MODEL.CROSS_ATTENTION_LAYERS = 2
...
# số epoch không cải thiện mAP trước khi dừng sớm
_C.SOLVER.STAGE2.PATIENCE = 10

# trọng số cho auxiliary cross-attention loss ở stage2
_C.SOLVER.STAGE2.AUX_CA_WEIGHT = 0.0
